...
# # Function to download the file from Google Drive link
# def download_file_from_google_drive(url):
#     response = requests.get(url)
#     file = BytesIO(response.content)
#     return file
...
file_url = "https://drive.google.com/uc?id=1uGAroK80c70qGzzgFkwZv98PU3wlf9rL"
...
# Function to recommend movies
def recommend(movie, val):
    # Access the similarity data and perform recommendation
    distances = similarity_data[movie_index]  # Adjust this based on your similarity data structure
    # Perform recommendation based on distances
